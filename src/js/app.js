...
function mostrarSeccion() {
    ...
    // Ocultar la seccioon que tenga la clase de mostar
...
function mostrarResumen() {
    ...
    if(Object.values(cita).includes('') || cita.servicios.length === 0) {
        mostarAlerta('Falta datos de Servicios, Fecha u Hora', 'error', '.contenido-resumen', false);
    ...
    servicios.forEach(servicio => {
        ...
        const precioServicio = document.createElement('P');
        const spanPrecioServicio = document.createElement('SPAN');
        spanPrecioServicio.textContent = `Precio: `;
        precioServicio.appendChild(spanPrecioServicio);
    ...
    resumen.appendChild(parrafoFecha);
